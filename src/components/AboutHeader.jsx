...
const AboutHeader = () => {
  ...
  return (
    ...
    <section className="relative h-[100vh]">
      <div className={`relative z-10 px-5 pb-4 container flex flex-col justify-end lg:justify-center h-full md:items-start items-center`}>
        <motion.h1
        ...
        <motion.div
          ...
          className="lg:max-w-sm xl:max-w-lg flex justify-start"
        >
          ...
          <div className={`rounded-md md:bg-transparent lg:pt-0 lg:pb-0 md:pt-2 md:pb-6`}>
            <ShinyText
              ...
              disabled={false}
              speed={5}
              className="text-center text-base md:text-lg lg:text-xl [text-shadow:_0_2px_8px_rgba(0,0,0,0.7)]"
