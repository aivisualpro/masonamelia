...
const ServiceBanner = ({ banner, bannerTwo, contact }) => {
  ...
  // CMS-driven hero text for acquisition, brokerage & insurance
  const heroTitleWhite = isAcquisition
    ...
    : isBrokerage
      ...
      : (contact?.insurance_hero_title_white || "Aircraft ");
  const heroTitleBlue = isAcquisition
    ...
    : isBrokerage
      ...
      : (contact?.insurance_hero_title_blue || "Insurance");
  const heroDesc = isAcquisition
    ...
    : isBrokerage
      ...
      : (contact?.insurance_hero_description || "Our trusted partners at Titan Insurance specialize exclusively in high-end owner-flown piston and turbine aircraft, backed by decades of aviation insurance expertise. Get a tailored quote today.");
  ...
  const mobileDesc = isAcquisition
    ...
    : isBrokerage
      ...
      : (contact?.insurance_hero_title_white || "Aircraft ") + (contact?.insurance_hero_title_blue || "Insurance");
  const bgImage = (isAcquisition && contact?.acquisition_hero_bg_image) || (isBrokerage && contact?.brokerage_hero_bg_image) || (isInsurance && contact?.insurance_hero_bg_image) || banner;
