...
const Skynet = ({ banner, titleWhite, titleBlue, description }) => {
  ...
  const desc = description || "No guesswork. No lag. Real-time market intelligence that gives our clients the sharpest edge; Fast, factual, and unbeatable.";
  const mobileDesc = "No Guesswork. No Lag. Just Real-Time Market Intelligence That Gives You the Edge";
